        ...
        sx={{
          ...
          <Container maxWidth='lg' sx={{height: '100%'}}>
            <Box display='flex' height='100%' flexDirection='column' justifyContent='center' alignItems='center' width='100%'>
              <Typography variant="h6" textTransform='none' color="common.black" textAlign='center'>Não perca esta oportunidade</Typography>
              <Typography variant="h5" color="primary" textAlign='center'>Aproveite 10% de Desconto nas Explicações Online!</Typography>
              <Typography variant="body1" color="common.black" textAlign='center'>* Válido apenas para alunos da Escola Secundária António Damásio</Typography>
            </Box>
          </Container>
      </Box>
    </>
